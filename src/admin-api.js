...
router.post('/game/cards', (req, res) => {
  const { id, name, image_url, rarity, base_power, price_toman, max_level, active, category_id, level_images, edition, max_supply } = req.body;
